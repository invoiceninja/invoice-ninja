...
<li>Heute ist Freitag, das Fälligkeitsdatum ist der Freitag einer jeden Woche. Das nächste Fälligkeitsdatum entspricht dem nächsten Freitag, also nicht heute.
    ...
    'pro_plan_remove_logo' => ':link, um das InvoiceNinja-Logo zu entfernen, indem du dem Pro Tarif beitrittst',
    ...
    'custom_invoice_item_fields_help' => 'Beim Erstellen eines Rechnungspostens ein Feld hinzufügen und die Bezeichnung und den Wert im PDF anzeigen.',
...
Sobald Sie die Beträge erhalten haben, kommen Sie bitte wieder zurück zu dieser Zahlungsmethoden-Seite und klicken Sie auf "Complete Verification" neben Ihrem Konto.',
    ...
    'update_font_cache' => 'Bitte eine Aktualisierung der Seite erzwingen, um den Schriftarten-Cache zu aktualisieren.',
    ...
    'country_Saint Pierre and Miquelon' => 'Saint-Pierre und Miquelon',
    'country_Saint Vincent and the Grenadines' => 'St. Vincent und die Grenadinen',
    ...
    'clone_to_quote' => 'Zum Angebot duplizieren',
    'convert' => 'Konvertiere',
...
https://invoiceninja.github.io/docs/migration/#troubleshooting',
    ...
    'user_not_associated_with_this_account' => 'Dieser Benutzer kann dieser Firma nicht zugeordnet werden. Vielleicht ist der Benutzer bereits mit einem anderen Konto registriert?',
    ...
    'shared_invoice_credit_counter' => 'Rechnungs-/Gutschrift Zähler teilen',
    ...
    'sidebar_inactive_font_color' => 'Schriftfarbe der inaktiven Seitenleiste',
    ...
    'upgrade_to_paid_plan_to_schedule' => 'Upgrade auf einen kostenpflichtigen Tarif zur Erstellung von Zeitplänen',
...
Leistungsempfängers',
    ...
    'nordigen_handler_error_contents_not_available' => 'Funktion nur im Enterprise-Tarif verfügbar.',
    ...
    'peppol_not_paid_message' => 'Für PEPPOL ist ein Enterprise-Tarif erforderlich. Bitte aktualisieren Sie Ihren Tarif.',
    ...
    'peppol_disconnect_long' => 'Ihre Umsatzsteuer-Identifikationsnummer wird nach der Trennung aus dem PEPPOL-Netzwerk entfernt. Sie können keine elektronischen Dokumente mehr senden oder empfangen.',
    ...
    'invalid_vat_number' => "Die Umsatzsteuer-Identifikationsnummer ist für das ausgewählte Land nicht gültig. Das Format sollte der Ländercode sein, gefolgt von einer Nummer, z. B. DE123456789",
    ...
    'changing_vat_and_id_number_note' => 'Sobald PEPPOL eingerichtet ist, können Sie Ihre Umsatzsteuer-Identifikationsnummer oder ID-Nummer nicht mehr ändern.',
    ...
    'saved_einvoice_details' => 'Gespeicherte E-Rechnungseinstellungen',
    ...
    'white_label_license_not_present' => 'Lizenz nicht gefunden. Stellen Sie sicher, dass LICENSE_KEY als Umgebungsvariable festgelegt ist.',
    ...
    'sales_above_threshold' => 'Umsatz über dem Schwellenwert',
    'client_address_required' => 'Für die elektronische Rechnungsstellung ist die vollständige Kunde erforderlich',
    'connected' => 'Verbunden',
    'email_count_quotes' => 'E-Mail :count Zitate',
    'activity_146' => 'E-Rechnung :invoice für :client erfolgreich zugestellt! :notes',
    'activity_147' => 'E-Rechnung :invoice für :client fehlgeschlagene Zustellung. :Hinweise',
    'peppol_routing_problem' => 'Routing-Problem. Kein Empfänger/Ziel gefunden.',
    'peppol_sending_failed' => 'Technisches Lieferproblem. Wiederholungsversuch nicht möglich',
    'peppol_cleared_for_sending' => 'Von der Steuerbehörde freigegeben, Versand an den Empfänger',
